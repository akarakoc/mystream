# Generated by Django 3.0.3 on 2020-05-15 21:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('follower', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='follower', to='streampage.communityUsers')),
                ('following', models.ManyToManyField(help_text='Vote', related_name='following', to='streampage.communityUsers')),
            ],
        ),
        migrations.CreateModel(
            name='DatatypeFields',
